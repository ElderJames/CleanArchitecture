...
namespace CleanArchitecture.WebUI.Client.Components
{
    public partial class RightContent
    {
        ...
        [Inject] protected IdentityContext IdentityContext { get; set; }
